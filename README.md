...
### 2022
+	**Unified Scaling Laws for Routed Language Models** [[arXiv](https://arxiv.org/abs/2202.01169)]
...
+	**Designing Effective Sparse Expert Models** [[arXiv]](https://arxiv.org/abs/2202.08906)

	*Barret Zoph, Irwan Bello, Sameer Kumar, Nan Du, Yanping Huang, Jeff Dean, Noam Shazeer, William Fedus*

+	**Mixture-of-Experts with Expert Choice Routing** [[arXiv]](https://arxiv.org/abs/2202.09368)

	*Yanqi Zhou, Tao Lei, Hanxiao Liu, Nan Du, Yanping Huang, Vincent Zhao, Andrew Dai, Zhifeng Chen, Quoc Le, James Laudon*

+	**Taming Sparsely Activated Transformer with Stochastic Experts** [[ICLR]](https://arxiv.org/abs/2110.04260)
...
+	**GShard: Scaling Giant Models with Conditional Computation and Automatic Sharding** [[ICLR]](https://openreview.net/pdf?id=qrwe7XHTmYb)
...
+	**Scaling Vision with Sparse Mixture of Experts.** [[NeurIPS](https://arxiv.org/abs/2101.03961)] 
...
+	**Scalable Transfer Learning with Expert Models** [[ICLR]](https://openreview.net/forum?id=23ZjUGpjcc)
...
+	**Efficient Large Scale Language Modeling with Mixtures of Experts** [[arXiv]](https://arxiv.org/abs/2112.10684)

	*Mikel Artetxe, Shruti Bhosale, Naman Goyal, Todor Mihaylov, Myle Ott, Sam Shleifer, Xi Victoria Lin, Jingfei Du, Srinivasan Iyer, Ramakanth Pasunuru, Giri Anantharaman, Xian Li, Shuohui Chen, Halil Akin, Mandeep Baines, Louis Martin, Xing Zhou, Punit Singh Koura, Brian O'Horo, Jeff Wang, Luke Zettlemoyer, Mona Diab, Zornitsa Kozareva, Ves Stoyanov*

+	**DSelect-k: Differentiable Selection in the Mixture of Experts with Applications to Multi-Task Learning** [[NeurIPS](https://arxiv.org/abs/2106.03760)]

	*Hussein Hazimeh, Zhe Zhao, Aakanksha Chowdhery, Maheswaran Sathiamoorthy, Yihua Chen, Rahul Mazumder, Lichan Hong, Ed H. Chi*

+	**Hash Layers For Large Sparse Models** [[NeurIPS](https://openreview.net/pdf?id=lMgDDWb1ULW)]

	*Stephen Roller, Sainbayar Sukhbaatar, Arthur Szlam, Jason Weston*

+	**BASE Layers: Simplifying Training of Large, Sparse Models.** [[ICML](http://proceedings.mlr.press/v139/lewis21a/lewis21a.pdf)]

	*Mike Lewis, Shruti Bhosale, Tim Dettmers, Naman Goyal, Luke Zettlemoyer*
  
+	**M6-T: Exploring Sparse Expert Models and Beyond** [[arXiv](https://arxiv.org/abs/2105.15082)]
...
+	**Dense-to-Sparse Gate for Mixture-of-Experts** [[arXiv]](https://arxiv.org/abs/2112.14397)

	*Xiaonan Nie, Shijie Cao, Xupeng Miao, Lingxiao Ma, Jilong Xue, Youshan Miao, Zichao Yang, Zhi Yang, Bin Cui*

+	**Sparse MoEs meet Efficient Ensembles** [[arXiv]](https://arxiv.org/abs/2110.03360)
...
### 2019
+	**Mixture Models for Diverse Machine Translation: Tricks of the Trade.** [[ICML](https://arxiv.org/abs/1902.07816)]

	*Tianxiao Shen, Myle Ott, Michael Auli, Marc'Aurelio Ranzato*

### 2017
+ **Outrageously Large Neural Networks: The Sparsely-Gated Mixture-of-Experts Layer.** [[ICLR](https://arxiv.org/abs/1701.06538)]
...
+	**DeepSpeed-MoE: Advancing Mixture-of-Experts Inference and Training to Power Next-Generation AI Scale** [[arXiv](https://arxiv.org/abs/2201.05596)]

	*Samyam Rajbhandari, Conglong Li, Zhewei Yao, Minjia Zhang, Reza Yazdani Aminabadi, Ammar Ahmad Awan, Jeff Rasley, Yuxiong He*

### 2021

+	**FastMoE: A Fast Mixture-of-Expert Training System** [[arXiv](https://arxiv.org/abs/2103.13262)]
...
+	**Video Recommendation with Multi-gate Mixture of Experts Soft Actor Critic** [[SIGIR](https://dl.acm.org/doi/abs/10.1145/3397271.3401238)]

	*Dingcheng Li, Xu Li, Jun Wang, Ping Li*

+	**Beyond Distillation: Task-level Mixture-of-Experts for Efficient Inference** [[EMNLP]](https://arxiv.org/abs/2110.03742)

	*Sneha Kudugunta, Yanping Huang, Ankur Bapna, Maxim Krikun, Dmitry Lepikhin, Minh-Thang Luong, Orhan Firat*
	
+	**MSSM: A Multiple-level Sparse Sharing Model for Efficient Multi-Task Learning** [[SIGIR](https://dl.acm.org/doi/10.1145/3404835.3463022)] 

+	**DEMix Layers: Disentangling Domains for Modular Language Modeling** [[arXiv](https://arxiv.org/abs/2108.05036)]

    *Suchin Gururangan, Mike Lewis, Ari Holtzman, Noah A. Smith, Luke Zettlemoyer*

### 2020
+	**Multitask Mixture of Sequential Experts for User Activity Streams.**[[SIGKDD](https://dl.acm.org/doi/10.1145/3394486.3403359)]

	*Zhen Qin, Yicheng Cheng, Zhe Zhao, Zhe Chen, Donald Metzler, Jingzheng Qin*
	
### 2018

+	**Modeling Task Relationships in Multi-task Learning with Multi-gate Mixture-of-Experts** [[SIGKDD](https://dl.acm.org/doi/10.1145/3219819.3220007)]
